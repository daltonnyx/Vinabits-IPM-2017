...
{
    public partial class VerticalDefault : TemplateContent, IXafPopupWindowControlContainer, IXafSecurityActionContainerHolder, IHeaderImageControlContainer
    {
        static VerticalDefault()
        {
